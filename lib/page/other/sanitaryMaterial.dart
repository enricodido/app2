...
class SchedaControlloMaterialeSanitarioWidget extends StatefulWidget {

  @override
  _SchedaControlloMaterialeSanitarioWidgetState createState() =>
      _SchedaControlloMaterialeSanitarioWidgetState();
}

class _SchedaControlloMaterialeSanitarioWidgetState
    extends State<SchedaControlloMaterialeSanitarioWidget> {
                        ...
                        children: [
                          Padding(
                            ...
                            child: FlutterFlowRadioButton(
                              ...
                              buttonPosition: RadioButtonPosition.left,
                              direction: Axis.vertical,
                              radioButtonColor: Color(0xFF707070),
                              inactiveRadioButtonColor: Color(0x8A000000),
                              toggleable: false,
                              horizontalAlignment: WrapAlignment.start,
                              verticalAlignment: WrapCrossAlignment.start,
